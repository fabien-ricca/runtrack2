...
<?php 
    ...
    $request = $mysqli->query("SELECT prenom, nom, naissance FROM etudiants WHERE naissance BETWEEN '1998-01-01' AND '2018-01-01'");       // On lance la requête pour récupérer la table
...
<body>
    <table>
        <thead>
            <tr>
            <?php 
                    foreach ($line as $key => $value){              // Pour chaque élément du tableau (première ligne)
