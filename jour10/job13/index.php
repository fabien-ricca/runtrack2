...
<?php 
    ...
    $request = $mysqli->query("SELECT salles.nom as `Nom de Salle`, etage.nom as `Nom d'étage` 
                                FROM salles INNER JOIN etage 
                                WHERE salles.id_etage = etage.id");       // On lance la requête pour récupérer la table
